  ...
  return (
    <div className="text-center px-4">
              ...
              {m.linkedin ? (
                ...
                <span className="inline-flex items-center gap-2 text-sm uppercase tracking-[0.14em] font-semibold text-[var(--ink)] mb-2 whitespace-nowrap">
                  {m.name}
                </span>
              )}
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12 py-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 text-xs">
        <div className="text-[oklch(0.75_0.01_85)] space-y-1 leading-relaxed">
          ...
          <p>
            ...
            {" · "}
            <a href="tel:+393780118145" className="hover:text-[var(--bronze)] transition-colors">+39 378 011 8145</a>
          </p>
